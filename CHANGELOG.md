...
* Here's the one-line commit message for the changes: ([d7f9802](https://github.com/yinglichina8848/GraphRenderRestructured/commit/d7f9802))
* Merge branch 'main' of github.com:yinglichina8848/GraphRenderRestructured ([5b83d07](https://github.com/yinglichina8848/GraphRenderRestructured/commit/5b83d07))
* test：补充工厂包形状类的边界测试及toString方法测试 ([680f250](https://github.com/yinglichina8848/GraphRenderRestructured/commit/680f250))
* The changes include two main parts: adding a missing import for `@AfterEach` in the test class and s ([66d7c0a](https://github.com/yinglichina8848/GraphRenderRestructured/commit/66d7c0a))
* The diff shows that the DrawingPanel tests were throwing null pointer exceptions due to issues with  ([1dbe644](https://github.com/yinglichina8848/GraphRenderRestructured/commit/1dbe644))
* The issue was in the SwingUITest class where the Mockito verification for JOptionPane.showMessageDia ([f502721](https://github.com/yinglichina8848/GraphRenderRestructured/commit/f502721))
* 根据提供的测试代码差异，可以看到主要修改如下： ([a7e5bc9](https://github.com/yinglichina8848/GraphRenderRestructured/commit/a7e5bc9))
* 根据提供的补丁内容，改动主要是为解决测试编译错误，具体包括： ([c5361d2](https://github.com/yinglichina8848/GraphRenderRestructured/commit/c5361d2))
* 补充了单元测试，总体覆盖率达到了 86% ([67298cb](https://github.com/yinglichina8848/GraphRenderRestructured/commit/67298cb))
* 补充单元测试，整体覆盖率 78%，只有界面类没有单元测试覆盖了。 ([a1880e1](https://github.com/yinglichina8848/GraphRenderRestructured/commit/a1880e1))
* docs: 补充了单元测试和注释，代码覆盖率达到了 86%， 基础类的源码基本上都有注释，准备冻结项目。 ([c7ffabd](https://github.com/yinglichina8848/GraphRenderRestructured/commit/c7ffabd))
* fix: 为按钮添加名称并移除重复导入 ([02e8697](https://github.com/yinglichina8848/GraphRenderRestructured/commit/02e8697))
* fix: 修复 SwingUITest 测试中 showMessageDialog 参数校验错误 ([9d26cc8](https://github.com/yinglichina8848/GraphRenderRestructured/commit/9d26cc8))
* fix: 修复SwingUI保存加载测试用例中的文件路径验证问题 ([cbd0b06](https://github.com/yinglichina8848/GraphRenderRestructured/commit/cbd0b06))
* fix: 修复SwingUI测试路径验证和DrawingPanel渲染逻辑 ([7122263](https://github.com/yinglichina8848/GraphRenderRestructured/commit/7122263))
* fix: 修复图形工厂静态调用非静态方法导致的编译错误 ([e99d217](https://github.com/yinglichina8848/GraphRenderRestructured/commit/e99d217))
* fix: 修复测试失败和空指针问题 ([f92f027](https://github.com/yinglichina8848/GraphRenderRestructured/commit/f92f027))
* fix: 在基础图形工厂中添加参数校验 ([cc00040](https://github.com/yinglichina8848/GraphRenderRestructured/commit/cc00040))
* fix: 实现Ellipse的toString方法使其通过测试 ([03f686e](https://github.com/yinglichina8848/GraphRenderRestructured/commit/03f686e))
* fix: 移除BasicShapeFactory中的重复package声明 ([224b37d](https://github.com/yinglichina8848/GraphRenderRestructured/commit/224b37d))
* fix: 重构文件选择逻辑并添加按钮存在性测试 ([2d91e20](https://github.com/yinglichina8848/GraphRenderRestructured/commit/2d91e20))
* test: 为界面类添加单元测试 ([b932517](https://github.com/yinglichina8848/GraphRenderRestructured/commit/b932517))
* test: 修复因阻塞式对话框导致的载入保存测试失败 ([32c6d20](https://github.com/yinglichina8848/GraphRenderRestructured/commit/32c6d20))
* test: 增加SwingUI文件选择、消息显示和回退渲染器测试 ([b76d77f](https://github.com/yinglichina8848/GraphRenderRestructured/commit/b76d77f))
* test: 补充工厂和验证器的异常测试 ([cc2e539](https://github.com/yinglichina8848/GraphRenderRestructured/commit/cc2e539))
* test: 补充工厂类测试，覆盖异常和toString ([5fd0f78](https://github.com/yinglichina8848/GraphRenderRestructured/commit/5fd0f78))
* chore: 放宽 createFallbackRenderer 方法访问权限以供测试 ([6f7afc7](https://github.com/yinglichina8848/GraphRenderRestructured/commit/6f7afc7))
* chore: 移除保存图形的方法 ([7943023](https://github.com/yinglichina8848/GraphRenderRestructured/commit/7943023))
* feat: 补全了界面类的单元测试，总体代码覆盖率达到 86%，项目准备进入冻结状态，不再继续改进。 ([fe8e951](https://github.com/yinglichina8848/GraphRenderRestructured/commit/fe8e951))
